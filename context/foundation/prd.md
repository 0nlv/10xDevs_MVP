...
# Product Requirements Document: ProfitLeak

## Vision & Problem Statement

Właściciele mikro i małych firm (2–20 osób) odczuwają ten problem wtedy, gdy mimo dużej liczby zleceń i rosnących przychodów nie widzą realnego zysku lub brakuje im pieniędzy na koncie. Moment bólu pojawia się, gdy realizują wiele zleceń, przychody rosną, ale gotówka nie rośnie proporcjonalnie. Koszt dzisiaj to podejmowanie złych decyzji — utrzymywanie nierentownych klientów, zaniżone wyceny oraz utracony zysk i płynność finansowa.
...
*Brak otwartych pytań — wszystkie wymagane elementy zostały zdefiniowane w shape-notes.md.*
